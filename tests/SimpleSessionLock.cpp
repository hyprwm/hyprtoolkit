...
int main(int argc, char** argv, char** envp) {
    ...
    backend->m_events.outputAdded.listenStatic([](uint32_t outputId) {
        windows.emplace_back(CWindowBuilder::begin()->type(HT_WINDOW_LOCK_SURFACE)->prefferedOutput(outputId)->commence());
